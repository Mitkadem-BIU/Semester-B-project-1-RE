...
namespace RegretionBasedDll
{
    public class CorrelatedFeatures
    {
        ...
        double features_x_max, features_x_min, features_y_max, features_y_min;
        Line lin_reg;
        Circle minCircle;
        bool isHybrid;

        public CorrelatedFeatures(string f1, string f2, double fs_x_max, double fs_x_min, double fs_y_max, double fs_y_min, double c, double thres, Line lin_reg, Circle mC, bool isHybrid)
        {
            this.feature1 = f1;
            this.feature2 = f2;
            this.features_x_max = fs_x_max;
            this.features_x_min = fs_x_min;
            this.features_y_max = fs_y_max;
            this.features_y_min = fs_y_min;
            this.correlation = c;
        ...
        public double GetMaxYFeatures() { return this.features_y_max; }
        public double GetMinYFeatures() { return this.features_y_min; }
    }
}
